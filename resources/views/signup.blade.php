                    ...
                    <form class="text-center" action="{{ route('clients.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-4">
                            <div class="custom-file">
                                <input id="photo" accept="image/*" type="file" name="photo" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" lang="ru">
                                <label style="text-align: left;" class="custom-file-label" for="inputGroupFile01">Ваше фото</label>
                            </div>
                        </div>
                        <div id="preview1" class="pb-2">
                            <img id="img1" class="preview rounded-circle mb-2" width="200">
                        </div>
