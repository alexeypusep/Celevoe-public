            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="category" class="form-control">
                        ...
                        <option value="Декор из сахарной мастики|Птицы|морские обитатели|насекомые">Декор из сахарной мастики/Птицы/морские обитатели/насекомые</option>
                ...
                <div class="form-group">
                    ...
                    <div id="preview1" class="pt-4">
                        <img id="img1" src="http://127.0.0.1:8000/{{ $tovar[0]['photo1'] }}" class="preview rounded mb-2" width="200">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="pt-4">
                        <img id="img2" src="http://127.0.0.1:8000/{{ $tovar[0]['photo2'] }}" class="preview rounded mb-2" width="200">
                    </div>
                    <script type="text/javascript">
                        photo2.onchange = evt => {
                ...
                <div class="form-group">
                    ...
                    <div class="pt-4">
                        <img id="img3" src="http://127.0.0.1:8000/{{ $tovar[0]['photo3'] }}" class="preview rounded mb-2" width="200">
                    </div>
                    <script type="text/javascript">
                        photo3.onchange = evt => {
                ...
                <div class="form-group">
                    ...
                    <div class="pt-4">
                        <img id="img4" src="http://127.0.0.1:8000/{{ $tovar[0]['photo4'] }}" class="preview rounded mb-2" width="200">
                    </div>
                    <script type="text/javascript">
                        photo4.onchange = evt => {
                ...
                <div class="form-group">
                    ...
                    <input name="mass" type="text" class="form-control" id="exampleInputName" value="{{ $tovar[0]['size'] }}" placeholder="Введите массу" required>
                </div>
                <div class="form-group">
