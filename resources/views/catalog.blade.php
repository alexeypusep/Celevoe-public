                ...
                <div class="col-lg-4 col-md-12 mb-lg-0 mb-4">
                    ...
                    <div class="card hoverable">
                        <?php
                            ...
                            $sort = 'asc';
                        ?>
                        <a href="{{ route('tovarsview', ['categ' => $categ, 'pole' => $pole, 'sort' => $sort]) }}">
                            <!-- Card image -->
                        ...
                        <div class="card-body">
                            ...
                            <!-- Title -->
                            <a href="{{ route('tovars.index', $categ) }}" class="black-text">Декор из сахарной мастики</a>
                            <!-- Text -->
                            <a href="{{ route('tovars.index', $categ) }}">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 mb-lg-0 mb-4">
                    ...
                    <div class="card hoverable">
                        <a href="">
                            <!-- Card image -->
                            <img class="card-img-top" src="https://sweetdecor.spb.ru/public/img/catalog/img/%D0%94%D0%B5%D0%BA%D0%BE%D1%80%20%D0%B8%D0%B7%20%D0%B8%D0%B7%D0%BE%D0%BC%D0%B0%D0%BB%D1%8C%D1%82%D0%B0%20%D0%BB%D0%B5%D0%B4%D0%B5%D0%BD%D1%86%D1%8B.jpeg" alt="Фото категории">

                            <!-- Card content -->
                            <div class="card-body">

                                <!-- Title -->
                                <a href="" class="black-text">Декор из изомальта (леденцы)</a>
                                <!-- Text -->
                                <p class="card-title text-muted font-small mt-3 mb-2">Изомальт — сахарозаменитель. Он делается из кристаллов сахара, но не повышает гликемический индекс. Леденцы из изомальта  можно использовать в качестве декора для тортов и как самостоятельный продукт (леденцы, леденцы-погремушки, топперы из изомальта, вазы из изомальта, элементы декора из изомальта).</p>
                ...
                <div class="col-lg-4 col-md-12 mb-lg-0 mb-4">
                    ...
                    <div class="card hoverable">
                        <a href="">
                            <!-- Card image -->
                            <img class="card-img-top" src="https://sweetdecor.spb.ru/public/img/catalog/img/%D0%94%D0%B5%D0%BA%D0%BE%D1%80%20%D0%B8%D0%B7%20%D0%BC%D0%B0%D1%80%D1%88%D0%BC%D1%8D%D0%BB%D0%BB%D0%BE%D1%83.jpeg" alt="Фото категории">

                            <!-- Card content -->
                            <div class="card-body">

                                <!-- Title -->
                                <a href="" class="black-text">Декор из маршмэллоу</a>
                                <!-- Text -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 mb-lg-0 mb-4">
                    ...
                    <div class="card hoverable">
                        <a href="">
                            <!-- Card image -->
                            <img class="card-img-top" src="https://sweetdecor.spb.ru/public/img/catalog/img/%D0%91%D0%B5%D0%B7%D0%B5.jpeg" alt="Фото категории">
                            <!-- Card content -->
                            <div class="card-body">
                                <!-- Title -->
                                <a href="" class="black-text">Безе</a>
                                <!-- Text -->
                                <p class="card-title text-muted font-small mt-3 mb-2">Безе (меренга) – десерт из  взбитых и запеченных яичных белков. В этом разделе Вы найдете  безе на палочке, россыпью, в рожке  разных форм и расцветок. Безе на палочке. Безе россыпью. Безе в рожке. Безе в подарочной коробочке.</p>
                            </div>
                        </a>
                    </div>
                    <!-- Card -->
